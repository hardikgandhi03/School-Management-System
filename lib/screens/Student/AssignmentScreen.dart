...
import 'package:school_management_system/models/Assignment.dart';
...
class _AssignmentScreenState extends State<AssignmentScreen> {
  ...
  void getData() async {
    ...
    var res = await NetworkHelper.getData(
        path: 'studentModule/getAssignment.php', parameters: {'sid': prefs.getString('UserID')!});
    if (res['status']) {
      setState(() {
        List data = res['data'];
        _assignmentList = data.map((assignment) => Assignment.fromJson(assignment)).toList();
        _isLoading = false;
      });
    } else {
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(context, AssignmentDetailsScreen.id,
                            arguments: _assignmentList[index]);
                      },
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Text(
                                _assignmentList[index].subjectName,
                                style: TextStyle(
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    _assignmentList[index].issueDate,
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    _assignmentList[index].dueDate.toString(),
                                    textAlign: TextAlign.end,
                                    style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16.0),
                                  ),
                                )
