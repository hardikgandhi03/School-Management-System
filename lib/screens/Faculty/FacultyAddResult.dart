...
class _FacultyAddResultState extends State<FacultyAddResult> {
  ...
  List subjects = ['Maths', 'English', 'Science', 'Drawing', 'Computer', 'Social Study', 'Biology'];
  List gainMarks = [];
  List grade = [];
  List totalMarks = [];
  String changeValue = '';
                ...
                Row(
                  children: [
                    ...
                    Text(
                      "Add Results",
                      style: TextStyle(
                          fontSize: 24, fontFamily: "source pro sans", color: Colors.white),
                    ),
                  ],
                ),
                Spacer(),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                            ...
                            child: Text(
                              "Roll number",
                              style: TextStyle(color: Color(0xffa5a5a5), fontSize: 18),
                            )),
                        SizedBox(
                          height: 10,
                        ),
                              ...
                              Padding(
                                ...
                                child: FlatButton(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                        color:
                                            changeValue.isEmpty ? Colors.grey : Color(0xff2351ad),
                                        fontSize: 18),
                                  ),
                                  color: Color(0xffe6efff),
                                ),
