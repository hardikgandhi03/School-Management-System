                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: day == _selectedDay ? Color(0xFF2351AD) : Colors.white,
                              ),
                              child: Center(
                                child: Text(
                                  day,
                                  style: TextStyle(
                                    ...
                                    color: day == _selectedDay ? Colors.white : Colors.black,
                                  ),
                                ),
                              ),
                            ),
                      ...
                      .map(
                        (Period p) => Container(
                          ...
                          child: p.isLunch
                              ...
                              : GestureDetector(
                                  onTap: () {
                                    Navigator.of(context).pushNamed(FacultyStudentList.id,
                                        arguments: {'type': true});
                                  },
                                  child: Card(
                                    elevation: 0,
